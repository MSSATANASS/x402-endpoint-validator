...
#   $10 authorization-evidence-path (workspace-relative JSON bundle; optional)
#
...
PROBE_METHOD="${8:-auto}"
STRICT_V2="${9:-false}"
AUTHORIZATION_EVIDENCE_PATH="${10:-}"
...
export X402V_AUTHORIZATION_EVIDENCE_PATH="${AUTHORIZATION_EVIDENCE_PATH}"
